...
struct CarState {
  ...
  vEgoCluster @44 :Float32 = -1.0;  # best estimate of speed shown on car's instrument cluster, used for UI
  ...
  struct CruiseState {
    enabled @0 :Bool;
    speed @1 :Float32;
    speedCluster @6 :Float32 = -1.0;  # Set speed as shown on instrument cluster
    available @2 :Bool;
